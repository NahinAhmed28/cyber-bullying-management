...
{
  const VIEW_PATH = 'admin.application.';
  ...
  public function index()
  {
    ...
    $applications = Application::with('stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->orderBy('id','desc')->utwd()->paginate(100);
  ...
  {
    $this->authorize('create',App\Application::class);
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('admin.application')->with([
  ...
  {
    $this->authorize('update',App\Application::class);
  ...
  {
    $this->authorize('edit_suspicious_info',App\Application::class);
    $application = Application::with('stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('edit_step_info',App\Application::class);
    $application = Application::with( 'stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('edit_addmember_info',App\Application::class);
    $application = Application::with( 'stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
