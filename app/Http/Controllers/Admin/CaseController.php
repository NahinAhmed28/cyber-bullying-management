...
class CaseController extends Controller
{
  ...
  {    
    $this->authorize('delete',App\Applicationn::class);
  ...
  {   
    $this->authorize('delete_single_file',App\Applicationn::class);
    $file = File::find($id);
  ...
  {
    $this->authorize('update_suspicious_info',App\Applicationn::class);
  ...
  {   
    $this->authorize('delete_suspicious_info',App\Applicationn::class);
  ...
  {
    $this->authorize('update_step_info',App\Applicationn::class);
  ...
  {   
    $this->authorize('delete_step_info',App\Applicationn::class);
    $step = Step::find($id);
  ...
  {
    $this->authorize('update_addmember_info',App\Applicationn::class);
  ...
  {   
    $this->authorize('delete_addmember_info',App\Applicationn::class);
    $step = Step::find($id);
    if ( is_null($step) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
