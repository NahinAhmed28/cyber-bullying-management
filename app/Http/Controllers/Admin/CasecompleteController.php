...
class CasecompleteController extends Controller
{
  const VIEW_PATH = 'admin.casecomplete.';
  ...
  public function index($cid= 0 )
  {
    ...
    $this->authorize('read',Casecomplete::class);
    $totalApplication = Application::where('case_status_id', Admin::Complete)->count();
    $caseTypesWithCount = CaseType::withCount('completeapplications')->get();



    if ($cid != 0  )
    {
        $applications = Application::with('stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')
            ->where('case_status_id', Admin::Complete)
  ...
  {
    $this->authorize('create',App\Casecomplete::class);
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('admin.casecomplete')->with([
  ...
  {
    $this->authorize('update',App\Casecomplete::class);
    $application = Application::with('stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
  ...
  {    
    $this->authorize('delete',App\Casecomplete::class);
  ...
  {   
    $this->authorize('delete_single_file',App\Casecomplete::class);
    $file = File::find($id);
  ...
  {
    $this->authorize('edit_suspicious_info',App\Casecomplete::class);
    $application = Application::with('stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('update_suspicious_info',App\Casecomplete::class);
  ...
  {   
    $this->authorize('delete_suspicious_info',App\Casecomplete::class);
  ...
  {
    $this->authorize('edit_step_info',App\Casecomplete::class);
    $application = Application::with( 'stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('update_step_info',App\Casecomplete::class);
  ...
  {   
    $this->authorize('delete_step_info',App\Casecomplete::class);
    $step = Step::find($id);
  ...
  {
    $this->authorize('edit_addmember_info',App\Casecomplete::class);
    $application = Application::with( 'stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('update_addmember_info',App\Casecomplete::class);
  ...
  {   
    $this->authorize('delete_addmember_info',App\Casecomplete::class);
    $step = Step::find($id);
    if ( is_null($step) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('show',App\Casecomplete::class);
    $application = Application::with('stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
    ...
    $case_statuses = CaseStatus::whereIn('id', [Admin::Pending,Admin::Declined,Admin::Ongoing, Admin::Incomplete, Admin::Complete])->get();
    $risks = Risk::get();
    //$walkings = Admin::where('user_type_id',Admin::WalkingGroup)->get();
    $walkings = Admin::get();
    if ($application->users) {
