...
class CasedeclinedController extends Controller
{
  const VIEW_PATH = 'admin.casedeclined.';
  ...
  public function index($cid= 0 )
  {
    ...
    $this->authorize('read',Casedeclined::class);
    $totalApplication = Application::where('case_status_id', Admin::Declined)->count();
    $caseTypesWithCount = CaseType::withCount('declinedapplications')->get();
    ...
    if ($cid != 0  )
    {
        $applications = Application::with('step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')
            ->where('case_status_id', Admin::Declined)
  ...
  {
    $this->authorize('create',App\Casedeclined::class);
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('admin.casedeclined')->with([
  ...
  {
    $this->authorize('update',App\Casedeclined::class);
  ...
  {    
    $this->authorize('delete',App\Casedeclined::class);
  ...
  {   
    $this->authorize('delete_single_file',App\Casedeclined::class);
    $file = File::find($id);
  ...
  {
    $this->authorize('edit_suspicious_info',App\Casedeclined::class);
    $application = Application::with('step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('update_suspicious_info',App\Casedeclined::class);
  ...
  {   
    $this->authorize('delete_suspicious_info',App\Casedeclined::class);
  ...
  {
    $this->authorize('edit_step_info',App\Casedeclined::class);
    $application = Application::with( 'step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('update_step_info',App\Casedeclined::class);
  ...
  {   
    $this->authorize('delete_step_info',App\Casedeclined::class);
    $step = Step::find($id);
  ...
  {
    $this->authorize('edit_addmember_info',App\Casedeclined::class);
    $application = Application::with( 'step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('update_addmember_info',App\Casedeclined::class);
  ...
  {   
    $this->authorize('delete_addmember_info',App\Casedeclined::class);
    $step = Step::find($id);
    if ( is_null($step) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('show',App\Casedeclined::class);
    $application = Application::with('step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
