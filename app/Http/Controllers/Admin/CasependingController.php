...
class CasependingController extends Controller
{
  const VIEW_PATH = 'admin.casepending.';
  ...
  public function index($cid= 0 )
  {
    ...
    $this->authorize('read',Casepending::class);
    $totalApplication = Application::where('case_status_id', Admin::Pending)->count();
    $caseTypesWithCount = CaseType::withCount('pendingapplications')->get();
    ...
    if ($cid != 0  )
    {
        $applications = Application::with('stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')
            ->where('case_status_id', Admin::Pending)
  ...
  {
    $this->authorize('create',App\Casepending::class);
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('admin.casepending')->with([
  ...
  {
    $this->authorize('update',App\Casepending::class);
  ...
  {    
    $this->authorize('delete',App\Casepending::class);
  ...
  {   
    $this->authorize('delete_single_file',App\Casepending::class);
    $file = File::find($id);
  ...
  {
    $this->authorize('edit_suspicious_info',App\Casepending::class);
    $application = Application::with('stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('update_suspicious_info',App\Casepending::class);
  ...
  {   
    $this->authorize('delete_suspicious_info',App\Casepending::class);
  ...
  {
    $this->authorize('edit_step_info',App\Casepending::class);
    $application = Application::with( 'stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('update_step_info',App\Casepending::class);
  ...
  {   
    $this->authorize('delete_step_info',App\Casepending::class);
    $step = Step::find($id);
  ...
  {
    $this->authorize('edit_addmember_info',App\Casepending::class);
    $application = Application::with( 'stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('update_addmember_info',App\Casepending::class);
  ...
  {   
    $this->authorize('delete_addmember_info',App\Casepending::class);
    $step = Step::find($id);
    if ( is_null($step) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
  ...
  {
    $this->authorize('show',App\Casepending::class);
    $application = Application::with('stepfeed','step','stepdate','file','suspect','division','district','upazila','thana','caseType','caseCategory','guardianType', 'caseStatus')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
    ...
    $case_statuses = CaseStatus::whereIn('id', [Admin::Pending,Admin::Declined,Admin::Ongoing])->get();
    $risks = Risk::get();
    //$walkings = Admin::where('user_type_id',Admin::WalkingGroup)->get();
    $walkings = Admin::get();
    if ($application->users) {
