        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            @can('create', app('App\Models\Admin'))
              <a href="{{ route('admin.admin.create') }}" class="btn btn-outline-light form-control btn-add-new">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th>{{__('admin.admin.designation')}} </th>
                    <th>{{__('admin.admin.office_designation')}} </th>
