      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            ...
            <a href="{{ route('admin.application.create') }}" class="btn btn-outline-light form-control btn-add-new">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr>
                    <th>#</th>
                    <th>{{__('admin.application.code')}}</th>
                    <th>{{__('admin.application.name')}}</th>

                    <th>{{ __('admin.application.victim') }} {{ __('admin.admin.division') }}</th>
                    <th>{{ __('admin.application.victim') }} {{ __('admin.admin.district') }}</th>
                    <th>{{ __('admin.application.victim') }} {{ __('admin.admin.upazila') }}</th>
                    <th>{{ __('admin.application.victim') }} {{ __('admin.admin.thana') }}</th>

                    <th>{{__('admin.application.address')}}</th>

                    <th>{{__('admin.application.guardian')}}</th>
                    <th>{{__('admin.application.dob')}}</th>
                    <th>{{__('admin.application.age')}}</th>
                    <th>{{__('admin.application.gender')}}</th>
                    <th>{{__('admin.application.contact')}}</th>
                    <th>{{__('admin.application.guardian_contact')}}</th>

                    <th>{{__('admin.application.class')}}</th>
                    <th>{{__('admin.application.school')}}</th>


                    <th>{{__('admin.application.title')}}</th>
                    <th>{{__('admin.application.title_details')}}</th>
                    <th>{{__('admin.application.created_at')}}</th>

                    <th>{{__('admin.application.update_suspicious_info')}}</th>
                    <th>{{__('admin.application.update_step_info')}}</th>
                    <th>{{__('admin.application.update_addmember_info')}}</th>

                    <th>{{__('admin.application.action')}}</th>
                  </tr>
                  </thead>
                  <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      @can('edit_suspicious_info', app('App\Models\Application'))
                        <a href="{{ route('admin.application.edit_suspicious_info', $application->id) }}" class="btn btn-xs btn-primary">
                          {{__('admin.application.update_suspicious_info_ans')}}
                        </a>
                      @endcan
                    </td>
                    ...
                    <td>
                      @can('edit_addmember_info', app('App\Models\Application'))
                        <a href="{{ route('admin.application.edit_addmember_info', $application->id) }}" class="btn btn-xs btn-info">
                          {{__('admin.application.update_addmember_info_ans')}}
                        </a>
                      @endcan
                    </td>
                    ...
                    <td>
                      @can('edit_step_info', app('App\Models\Application'))
                        <a href="{{ route('admin.application.edit_step_info', $application->id) }}" class="btn btn-xs btn-warning">
                          {{__('admin.application.update_step_info_ans')}}
                        </a>
                      @endcan
                    </td>
                    ...
                    <td>
                      @can('update', app('App\Models\Application'))
                        <a href="{{ route('admin.application.edit', $application->id) }}" class="btn btn-xs btn-primary"><i class="fas fa-edit"></i></a>
                      @endcan

                      @can('delete', app('App\Models\Application'))
                        <a href="{{ route('admin.application.delete', $application->id) }}" href1="{{ route('admin.application.delete', [$application->id,1]) }}" class="btn btn-xs btn-danger delete"><i class="fas fa-trash-alt"></i></a>
                      @endcan
