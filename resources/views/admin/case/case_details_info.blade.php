<div class="container-fluid pl-3 pt-2 " style="background-color: #F8FBF0" >
    ...
    <form>
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="row">
                    <div class="col-md-2">
                        <label for="name">{{ __('admin.case.name') }}</label>
                    </div>
                    <div class="col-md-10">
            ...
            <li class="list-group-item">
                <div class="row">
                    <div class="col-md-2">
                        <label for="email">{{ __('admin.case.age') }}</label>
                    </div>
                    <div class="col-md-10">
            ...
            <li class="list-group-item">
                <div class="row">
                    <div class="col-md-2">
                        <label for="message">{{ __('admin.case.address') }}</label>
                    </div>
                    <div class="col-md-10">
            ...
            <li class="list-group-item">
                <div class="row">
                    <div class="col-md-2">
                        <label for="message">{{ __('admin.case.case_category') }}</label>
                    </div>
                    <div class="col-md-10">
    ...
    <div class="row d-flex align-items-center py-4 pl-4">
        <div class="col-md-6">
            <h5 class="text-bold"> {{ __('admin.case.victim') }}: ( {{ $application->{'name_' . app()->getLocale()} }} )
                {{ __('admin.case.detail') }} </h5>
        </div>
        <div class="col-md-6 text-right">
            <a href="#" class="text-white rounded-pill p-4 mr-4" style="background-color: #6E4798">PDF ডাউনলোড করুন </a>
        </div>
            ...
            <div class="col-md-9">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="class">{{ __('admin.case.class') }}</label>
                            </div>
                            <div class="col-md-9">
                                <span id="class">:
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="school">{{ __('admin.case.school') }}</label>
                            </div>
                            <div class="col-md-9">
                                <span id="school">:
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="address">{{ __('admin.case.address') }}</label>
                            </div>
                            <div class="col-md-9">
                                <span id="address">:
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="contact">{{ __('admin.case.contact') }}</label>
                            </div>
                            <div class="col-md-9">
                                <span id="contact">:
                                     {{ (app()->getLocale() == 'en') ?
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="guardian">{{ __('admin.case.guardian') }}</label>
                            </div>
                            <div class="col-md-9">
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="guardian_contact">{{ __('admin.case.guardian_contact') }}</label>
                            </div>
                            <div class="col-md-9">
...
{{--    suspicious  info--}}
    ...
    <form>
        <div class="row bg-white py-2">
            ...
            <div class="col-md-3 text-bold">
                {{ __('admin.case.suspicious_image') }} : <br>
                <img src="https://mdbcdn.b-cdn.net/img/new/avatars/9.webp" alt="Your Image" class="img-fluid rounded" />
            </div>
        </div>
    </form>
