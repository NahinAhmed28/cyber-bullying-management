                        ...
                        <div class="card">
                            <div class="card-header">
                                <ul class="nav nav-pills">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="pill" href="#home">{{ __('admin.case.victim_info') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#menu1">{{ __('admin.case.suspicious_info') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#menu2">{{ __('admin.case.addmember_info') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#menu3">{{ __('admin.case.step_info') }}</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.card-header -->
                        ...
                        <div class="card">
                            <div class="tab-content">
                                <div id="home" class="tab-pane fade show active">
                                    @include('admin.case.central.victim_info')
                                </div>
                                <div id="menu1" class="tab-pane fade">
                                    @include('admin.case.central.suspicious_info')
                                </div>
                                <div id="menu2" class="tab-pane fade">
                                    @include('admin.case.central.members_info')
                                </div>
                                <div id="menu3" class="tab-pane fade">
                                    @include('admin.case.central.steps_info')
                                </div>
                            </div>
                        </div>
                    </div>
