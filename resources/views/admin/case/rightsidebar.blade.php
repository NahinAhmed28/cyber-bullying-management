<div class="card">
    <ul class="list-group text-bold">
        <li class="list-group-item">{{ __('admin.case.supporting_contact') }} :
            <span style="float:right">{{ __('admin.case.supporting_contact_no') }}  </span>
        </li>
        <li class="list-group-item">{{ __('admin.case.case_category') }} :
            <span style="float:right;font-weight: normal!important;border: 1px solid purple">
            {{ $application->caseCategory->{'title_' . app()->getLocale()} }}
            </span>
        </li>
        <li class="list-group-item">{{ __('admin.case.case_type') }} :
        ...
        <li class="list-group-item">{{ __('admin.case.case_status') }} :
        ...
        <div class="card p-2 m-3" style="background-color: #6E479814">
            ...
            <div class="card-body">
                ...
                <form>
                    <div class="form-row">
                        <div class="col">
                            <span type="text" class="form-control bg-transparent" >{{ __('admin.case.name') }} </span>
                        </div>
                        <div class="col">
                    ...
                    <div class="form-row pt-1">
                        <div class="col">
                            <span type="text" class="form-control bg-transparent" >{{ __('admin.case.age') }} </span>
                        </div>
                        <div class="col">
