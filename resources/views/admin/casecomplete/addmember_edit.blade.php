...
<div class="content-wrapper">
    ...
    <form class="form-edit-add" application="form" id="application_entry_form"
        action="{{ route('admin.casecomplete.update_addmember_info', $application->id) }} }}"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title text-info">{{ __('admin.casecomplete.addmember_info') }}</h3>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        @if ($edit)
                                            <div class="form-group">
                                                ...
                                                <label for="district_id"> {{ __('admin.admin.district') }} {{ __('admin.casecomplete.committee') }}  <!--<span style="color: red"> * </span>--></label>
                                    ...
                                    <div class="col-md-4">
                                        @if ($edit)
                                            <div class="form-group">
                                                <label for="upazila_id"> {{ __('admin.admin.upazila') }} {{ __('admin.casecomplete.committee') }} <!--<span style="color: red"> * </span>--></label>
                                    ...
                                    <div class="col-md-4">
                                        @if ($edit)
                                            <div class="form-group">
                                                <label for="admin_id"> {{ __('admin.casecomplete.walking') }} <!--<span style="color: red"> * </span>--></label>
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) {
            ...
            if (x < max_fields) {
                ...
                '<div class="col-md-5">'+
                    '<div class="form-group">'+
                        '<textarea rows="2" class="form-control" placeholder="{{ __('admin.casecomplete.step_details_en') }}" name="arraydata[step'+ x +'][step_details_en]" required></textarea>'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-5">'+
                    '<div class="form-group">'+
                        '<textarea rows="2" class="form-control" placeholder="{{ __('admin.casecomplete.step_details_bn') }}" name="arraydata[step'+ x +'][step_details_bn]" required></textarea>'+
                    '</div>'+
                '</div>'+
