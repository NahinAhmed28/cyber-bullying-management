        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-4">
                        <h5 class="text-light">{{ __('admin.casecomplete.name') }} :  {{ $application->{'name_' . app()->getLocale()} }}</h5>
                        <span class="text-light" style="font-size: 12px">{{ __('admin.casecomplete.address') }} :  {{ $application->{'address_' . app()->getLocale()} }}</span>
                    </div>

                    <div class="col-sm-2">
                        <span class="text-light text-bold" style="font-size: 16px">{{ __('admin.casecomplete.code') }} :
                        ...
                        <div class="card">
                            <div class="card-header">
                                <ul class="nav nav-pills">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="pill" href="#home">{{ __('admin.casecomplete.victim_info') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#menu1">{{ __('admin.casecomplete.suspicious_info') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#menu2">{{ __('admin.casecomplete.addmember_info') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#menu3">{{ __('admin.casecomplete.step_info') }}</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.card-header -->
                        ...
                        <div class="card">
                            <div class="tab-content">
                                <div id="home" class="tab-pane fade show active">
                                    @include('admin.casecomplete.central.victim_info')
                                </div>
                                <div id="menu1" class="tab-pane fade">
                                    @include('admin.casecomplete.central.suspicious_info')
                                </div>
                                <div id="menu2" class="tab-pane fade">
                                    @include('admin.casecomplete.central.members_info')
                                </div>
                                <div id="menu3" class="tab-pane fade">
                                    @include('admin.casecomplete.central.steps_info')
                                </div>
                            </div>
                        </div>
                    </div>
