              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr style="background-color: #6E4798; border-radius: 25px;" class="text-light">
                    ...
                    <th>{{ __('admin.casecomplete.victim') }} {{ __('admin.admin.division') }}</th>
                    <th>{{ __('admin.casecomplete.victim') }} {{ __('admin.admin.district') }}</th>
                    <th>{{ __('admin.casecomplete.victim') }} {{ __('admin.admin.upazila') }}</th>
                    <th>{{ __('admin.casecomplete.victim') }} {{ __('admin.admin.thana') }}</th>

                    <th>{{__('admin.casecomplete.address')}}</th>

                    <th>{{__('admin.casecomplete.guardian')}}</th>
                    <th>{{__('admin.casecomplete.dob')}}</th>
                    <th>{{__('admin.casecomplete.age')}}</th>
                    <th>{{__('admin.casecomplete.gender')}}</th>
                    <th>{{__('admin.casecomplete.contact')}}</th>
                    <th>{{__('admin.casecomplete.guardian_contact')}}</th>

                    <th>{{__('admin.casecomplete.class')}}</th>
                    <th>{{__('admin.casecomplete.school')}}</th>


                    <th>{{__('admin.casecomplete.title')}}</th>
                    <th>{{__('admin.casecomplete.title_details')}}</th>
                    <th>{{__('admin.casecomplete.created_at')}}</th>

                    <th>{{__('admin.casecomplete.update_suspicious_info')}}</th>
                    <th>{{__('admin.casecomplete.update_step_info')}}</th>
                    <th>{{__('admin.casecomplete.update_addmember_info')}}</th>
                  ...
                  <tr>
                    ...
                    <td>
                      @can('edit_suspicious_info', app('App\Models\Casecomplete'))
                        <a href="{{ route('admin.casecomplete.edit_suspicious_info', $application->id) }}" class="btn btn-xs btn-primary">
                          {{__('admin.casecomplete.update_suspicious_info_ans')}}
                        </a>
                      @endcan
                    </td>
                    ...
                    <td>
                      @can('update', app('App\Models\Casecomplete'))
                        <a href="{{ route('admin.casecomplete.edit', $application->id) }}" class="btn btn-xs btn-primary"><i class="fas fa-edit"></i></a>
                      @endcan

                      @can('delete', app('App\Models\Casecomplete'))
                        <a href="{{ route('admin.casecomplete.delete', $application->id) }}" href1="{{ route('admin.casecomplete.delete', [$application->id,1]) }}" class="btn btn-xs btn-danger delete"><i class="fas fa-trash-alt"></i></a>
                      @endcan
