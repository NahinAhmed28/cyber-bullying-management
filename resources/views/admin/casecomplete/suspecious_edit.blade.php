...
<div class="content-wrapper">
    ...
    <form class="form-edit-add" application="form" id="application_entry_form"
        action="{{ route('admin.casecomplete.update_suspicious_info', $application->id) }} }}"
                                ...
                                @if ($edit)
                                    @if (count($application->suspect) > 0 )
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_name_bn">{{ __('admin.casecomplete.suspicious_name_bn') }}</label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_details_en">{{ __('admin.casecomplete.suspicious_details_en') }}</label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_details_bn">{{ __('admin.casecomplete.suspicious_details_bn') }}</label>
                                                    <textarea rows="1" class="form-control"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_guardian_en">{{ __('admin.casecomplete.suspicious_guardian_en') }}</label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_guardian_bn">{{ __('admin.casecomplete.suspicious_guardian_bn') }}</label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_address_en">{{ __('admin.casecomplete.suspicious_address_en') }}</label>
                                                    <textarea rows="1" class="form-control"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_address_bn">{{ __('admin.casecomplete.suspicious_address_bn') }}</label>
                                                    <textarea rows="1" class="form-control"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_contact">{{ __('admin.casecomplete.suspicious_contact') }}</label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_guardian_contact">{{ __('admin.casecomplete.suspicious_guardian_contact') }}</label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_age">{{ __('admin.casecomplete.suspicious_age') }}</label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_photo">{{ __('admin.casecomplete.suspicious_photo') }}</label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group" style="margin-top: 8px;">
                                                    <label for="title_bn">{{ __('admin.casecomplete.suspicious_gender') }}: </label>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input {{ ($suspect->suspicious_gender) ? 'checked' : '' }} type="radio" class="form-check-input" name="arraydata[suspect{{$key+1}}][suspicious_gender]" value="1">{{ __('admin.casecomplete.suspicious_male') }}
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input {{ (!$suspect->suspicious_gender) ? 'checked' : '' }} type="radio" class="form-check-input" name="arraydata[suspect{{$key+1}}][suspicious_gender]" value="0">{{ __('admin.casecomplete.suspicious_female') }}
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <a style="margin-top: 7px;" href="{{ route('admin.casecomplete.delete_suspicious_info', $suspect->id) }}" href1="{{ route('admin.casecomplete.delete_suspicious_info', [$suspect->id,1]) }}" class="btn btn-xs btn-danger deletes"><i class="fas fa-trash-alt"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" style="margin-top: 8px;">
                                                ...
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" name="arraydata[suspect1][suspicious_gender]" value="1">{{ __('admin.casecomplete.suspicious_male') }}
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" name="arraydata[suspect1][suspicious_gender]" value="0">{{ __('admin.casecomplete.suspicious_female') }}
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) {
            ...
            if (x < max_fields) {
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][suspicious_name_en]" placeholder="{{ __('admin.casecomplete.suspicious_name_en') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][suspicious_name_bn]" placeholder="{{ __('admin.casecomplete.suspicious_name_bn') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][suspicious_guardian_en]" placeholder="{{ __('admin.casecomplete.suspicious_guardian_en') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][suspicious_guardian_bn]" placeholder="{{ __('admin.casecomplete.suspicious_guardian_bn') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="number" name="arraydata[suspect'+ x +'][suspicious_guardian_contact]" placeholder="{{ __('admin.casecomplete.suspicious_guardian_contact') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group" style="margin-top: 8px;">'+
                        ...
                        '<div class="form-check-inline">'+
                            '<label class="form-check-label">'+
                                '<input type="radio" class="form-check-input" name="arraydata[suspect'+ x +'][suspicious_gender]" value="1">{{ __('admin.casecomplete.suspicious_male') }}'+
                            '</label>'+
                        '</div>'+
                        '<div class="form-check-inline">'+
                            '<label class="form-check-label">'+
                                '<input type="radio" class="form-check-input" name="arraydata[suspect'+ x +'][suspicious_gender]" value="0">{{ __('admin.casecomplete.suspicious_female') }}'+
                            '</label>'+
                        '</div>'+
                    '</div>'+
                '</div>'+
