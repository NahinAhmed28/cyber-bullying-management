                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title text-info">{{ __('admin.casecomplete.suspicious_info') }}</h3>
                            </div>
                                ...
                                @if ($edit)
                                    @if (count($application->suspect) > 0 )
                                        ...
                                        {{-- <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="text" name="arraydata[suspect{{$key+1}}][title_en]" id="title_en{{$key+1}}" placeholder="{{ __('admin.casecomplete.suspect_title_en') }}" value="{{$suspect->name}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="text" name="arraydata[suspect{{$key+1}}][title_bn]" id="title_bn{{$key+1}}" placeholder="{{ __('admin.casecomplete.suspect_title_bn') }}" value="{{$suspect->name}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="suspicious_name_en">{{ __('admin.casecomplete.suspicious_name_en') }}</label>
                                                    <input type="text" name="arraydata[suspect{{$key+1}}][name_en]"
                                                        placeholder="{{ __('admin.casecomplete.suspicious_name_en') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="text" name="arraydata[suspect{{$key+1}}][name_bn]"
                                                        placeholder="{{ __('admin.casecomplete.suspicious_name_bn') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <textarea rows="1" class="form-control"
                                                        placeholder="{{ __('admin.casecomplete.suspicious_details_en') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <textarea rows="1" class="form-control"
                                                        placeholder="{{ __('admin.casecomplete.suspicious_details_bn') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="text" name="arraydata[suspect{{$key+1}}][guardian_en]"
                                                        placeholder="{{ __('admin.casecomplete.suspicious_guardian_en') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="text" name="arraydata[suspect{{$key+1}}][guardian_bn]"
                                                        placeholder="{{ __('admin.casecomplete.suspicious_guardian_bn') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <textarea rows="1" class="form-control"
                                                        placeholder="{{ __('admin.casecomplete.suspicious_address_en') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <textarea rows="1" class="form-control"
                                                        placeholder="{{ __('admin.casecomplete.suspicious_address_bn') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="number" name="arraydata[suspect{{$key+1}}][suspicious_contact]"
                                                        placeholder="{{ __('admin.casecomplete.suspicious_contact') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="number" name="arraydata[suspect{{$key+1}}][guardian_contact]"
                                                        placeholder="{{ __('admin.casecomplete.suspicious_guardian_contact') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="number" name="arraydata[suspect{{$key+1}}][suspicious_age]"
                                                        placeholder="{{ __('admin.casecomplete.suspicious_age') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group" style="margin-top: 8px;">
                                                    <label for="title_bn">{{ __('admin.casecomplete.gender') }}: </label>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input {{ ($application->gender) ? 'checked' : '' }} type="radio" class="form-check-input" name="arraydata[suspect{{$key+1}}][gender]" value="1">{{ __('admin.casecomplete.suspicious_male') }}
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input {{ (!$application->gender) ? 'checked' : '' }} type="radio" class="form-check-input" name="arraydata[suspect{{$key+1}}][gender]" value="0">{{ __('admin.casecomplete.suspicious_female') }}
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" style="margin-top: 8px;">
                                                ...
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" name="arraydata[suspect1][gender]" value="1">{{ __('admin.casecomplete.suspicious_male') }}
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" name="arraydata[suspect1][gender]" value="0">{{ __('admin.casecomplete.suspicious_female') }}
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="name_en">{{ __('admin.casecomplete.suspicious_name_en') }}</label>
                                ...
                                <div class="form-group">
                                    <label for="name_bn">{{ __('admin.casecomplete.suspicious_name_bn') }}</label>
                                ...
                                <div class="form-group">
                                    <label
                                        for="suspicious_details_en">{{ __('admin.casecomplete.suspicious_details_en') }}</label>
                                ...
                                <div class="form-group">
                                    <label
                                        for="suspicious_details_bn">{{ __('admin.casecomplete.suspicious_details_bn') }}</label>
                                ...
                                <div class="form-group">
                                    <label for="dob">{{ __('admin.casecomplete.suspicious_dob') }} </label>
                                    <input type="text" name="dob" id="suspicious_dob"
                                        placeholder="{{ __('admin.casecomplete.suspicious_dob') }}"
                                ...
                                <div class="form-group">
                                    <label for="title_bn"
                                        style="padding-right:20%;padding-top: 3%;">{{ __('admin.casecomplete.suspicious_gender') }}
                                        : </label>
                                        <br>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="gender" value="1"
                                                {{ ($edit && ($application->gender)) ? 'checked' : '' }}>{{ __('admin.casecomplete.suspicious_male') }}
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="gender" value="0"
                                                {{ ($edit && (!$application->gender)) ? 'checked' : '' }}>{{ __('admin.casecomplete.suspicious_female') }}
                                        </label>
                                    </div>
                                </div>

                                {{-- <div class="form-group">
                                    <label for="class_en">{{ __('admin.casecomplete.suspicious_class_en') }}</label>
                                    <input type="text" name="class_en" id="class_en"
                                        placeholder="{{ __('admin.casecomplete.suspicious_class_en') }}"
                                        value="{{ $edit?$application->class_en:old('class_en') }}"
                                        class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="class_bn">{{ __('admin.casecomplete.suspicious_class_bn') }}</label>
                                    <input type="text" name="class_bn" id="class_bn"
                                        placeholder="{{ __('admin.casecomplete.suspicious_class_bn') }}"
                                        value="{{ $edit?$application->class_bn:old('class_bn') }}"
                                        class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="school_en">{{ __('admin.casecomplete.suspicious_school_en') }}</label>
                                    <input type="text" name="school_en" id="school_en"
                                        placeholder="{{ __('admin.casecomplete.suspicious_school_en') }}"
                                        value="{{ $edit?$application->school_en:old('school_en') }}"
                                        class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="school_bn">{{ __('admin.casecomplete.suspicious_school_bn') }}</label>
                                    <input type="text" name="school_bn" id="school_bn"
                                        placeholder="{{ __('admin.casecomplete.suspicious_school_bn') }}"
                                ...
                                @if($edit)
                                    <div class="form-group">
                                        <label for="guardian_type_id">{{ __('admin.casecomplete.guardian_type') }}<!--<span style="color: red"> * </span>--></label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                    <label
                                        for="address_en">{{ __('admin.casecomplete.suspicious_address_en') }}</label>
                                ...
                                <div class="form-group">
                                    <label
                                        for="address_bn">{{ __('admin.casecomplete.suspicious_address_bn') }}</label>
                                ...
                                <div class="form-group">
                                    <label
                                        for="guardian_en">{{ __('admin.casecomplete.suspicious_guardian_en') }}</label>
                                ...
                                <div class="form-group">
                                    <label
                                        for="guardian_bn">{{ __('admin.casecomplete.suspicious_guardian_bn') }}</label>
                                ...
                                <div class="form-group">
                                    <label
                                        for="guardian_contact">{{ __('admin.casecomplete.suspicious_guardian_contact') }}</label>
                                ...
                                <div class="form-group">
                                    <label
                                        for="contact">{{ __('admin.casecomplete.suspicious_contact') }}</label>
                                ...
                                <div class="form-group">
                                    <label for="ssign">
                                        {{ __('admin.casecomplete.ssign') }} <span
                                            class="text-warning">
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) {
            ...
            if (x < max_fields) {
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][name_en]" placeholder="{{ __('admin.casecomplete.suspicious_name_en') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][name_bn]" placeholder="{{ __('admin.casecomplete.suspicious_name_bn') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<textarea rows="1" class="form-control" placeholder="{{ __('admin.casecomplete.suspicious_details_en') }}" name="arraydata[suspect'+ x +'][suspicious_details_en]" required></textarea>'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<textarea rows="1" class="form-control" placeholder="{{ __('admin.casecomplete.suspicious_details_bn') }}" name="arraydata[suspect'+ x +'][suspicious_details_bn]" required></textarea>'+
                    '</div>'+
                '</div>'+

                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][guardian_en]" placeholder="{{ __('admin.casecomplete.suspicious_guardian_en') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][guardian_bn]" placeholder="{{ __('admin.casecomplete.suspicious_guardian_bn') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<textarea rows="1" class="form-control" placeholder="{{ __('admin.casecomplete.suspicious_address_en') }}" name="arraydata[suspect'+ x +'][suspicious_address_en]" required></textarea>'+
                    '</div>'+
                '</div>'+

                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<textarea rows="1" class="form-control" placeholder="{{ __('admin.casecomplete.suspicious_address_bn') }}" name="arraydata[suspect'+ x +'][suspicious_address_bn]" required></textarea>'+
                    '</div>'+
                '</div>'+
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="number" name="arraydata[suspect'+ x +'][suspicious_contact]" placeholder="{{ __('admin.casecomplete.suspicious_contact') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+

                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="number" name="arraydata[suspect'+ x +'][guardian_contact]" placeholder="{{ __('admin.casecomplete.suspicious_guardian_contact') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="number" name="arraydata[suspect'+ x +'][suspicious_age]" placeholder="{{ __('admin.casecomplete.suspicious_age') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group" style="margin-top: 8px;">'+
                        ...
                        '<div class="form-check-inline">'+
                            '<label class="form-check-label">'+
                                '<input type="radio" class="form-check-input" name="arraydata[suspect'+ x +'][gender]" value="1">{{ __('admin.casecomplete.suspicious_male') }}'+
                            '</label>'+
                        '</div>'+
                        '<div class="form-check-inline">'+
                            '<label class="form-check-label">'+
                                '<input type="radio" class="form-check-input" name="arraydata[suspect'+ x +'][gender]" value="0">{{ __('admin.casecomplete.suspicious_female') }}'+
                            '</label>'+
                        '</div>'+
                    '</div>'+
                '</div>'+
