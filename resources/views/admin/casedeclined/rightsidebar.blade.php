<div class="card">
    <ul class="list-group text-bold">
        <li class="list-group-item">{{ __('admin.casedeclined.supporting_contact') }} :
            <span style="float:right">{{ __('admin.casedeclined.supporting_contact_no') }}  </span>
        </li>
        <li class="list-group-item">{{ __('admin.casedeclined.case_category') }} :
            <span style="float:right;font-weight: normal!important;border: 1px solid purple">
            {{ $application->caseCategory->{'title_' . app()->getLocale()} }}
            </span>
        </li>
        <li class="list-group-item">{{ __('admin.casedeclined.case_type') }} :
        ...
        <li class="list-group-item">{{ __('admin.casedeclined.case_status') }} :
        ...
        <div class="card p-2 m-3" style="background-color: #6E479814">
            ...
            <div class="card-body">
                ...
                <form>
                    <div class="form-row">
                        <div class="col">
                            <span type="text" class="form-control bg-transparent" >{{ __('admin.casedeclined.name') }} </span>
                        </div>
                        <div class="col">
                    ...
                    <div class="form-row pt-1">
                        <div class="col">
                            <span type="text" class="form-control bg-transparent" >{{ __('admin.casedeclined.age') }} </span>
                        </div>
                        <div class="col">
