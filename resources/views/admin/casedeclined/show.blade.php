                        ...
                        <div class="card">
                            <div class="card-header">
                                <ul class="nav nav-pills">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="pill" href="#home">কেস ফিড</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#menu1">আস্যেট সমূহ</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#menu2">কেস মেম্বার সমূহ</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#menu3">বিস্তারিত তথ্যাদি</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.card-header -->
                        ...
                        <div class="card">
                            <div class="tab-content">
                                <div id="home" class="tab-pane fade show active">
                                    @include('admin.casedeclined.case_feed')
                                </div>
                                <div id="menu1" class="tab-pane fade">
                                    @include('admin.casedeclined.case_asset')
                                </div>
                                <div id="menu2" class="tab-pane fade">
                                    @include('admin.casedeclined.case_member')
                                </div>
                                <div id="menu3" class="tab-pane fade">
                                    @include('admin.casedeclined.case_details_info')
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $(add_button).click(function (e) {
                ...
                if (x < max_fields) {
                    ...
                    $(wrapper).append('<div class="row">' +
                        ...
                        '<input type="text" name="arraydata[file'+ x +'][title_en]" id="title_en'+ x +'" placeholder="{{ __('admin.casedeclined.file_title_en') }}" value="" class="form-control">' +
                        '</div>' +
                        '</div>' +
                        '<div class="col-md-3">' +
                        '<div class="form-group">' +
                        '<input type="text" name="arraydata[file'+ x +'][title_bn]" id="title_bn'+ x +'" placeholder="{{ __('admin.casedeclined.file_title_bn') }}" value="" class="form-control">' +
                        '</div>' +
                        '</div>' +
                        '<div class="col-md-3">' +
                        '<div class="form-group">' +
