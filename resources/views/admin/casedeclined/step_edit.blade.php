...
<div class="content-wrapper">
    ...
    <form class="form-edit-add" application="form" id="application_entry_form"
        action="{{ route('admin.casedeclined.update_step_info', $application->id) }} }}"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title text-info">{{ __('admin.casedeclined.step_info') }}</h3>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="step_date">{{ __('admin.casedeclined.step_date') }} </label>
                                            <input type="text" name="step_date" id="step_date"
                                                placeholder="{{ __('admin.casedeclined.step_date') }}"
                                    ...
                                    <div class="col-md-4">
                                        @if($edit)
                                            <div class="form-group">
                                                <label for="case_status_id">{{ __('admin.casedeclined.case_status') }}<!--<span style="color: red"> * </span>--></label>
                                    ...
                                    <div class="col-md-4">
                                        @if($edit)
                                            <div class="form-group">
                                                <label for="risk_id">{{ __('admin.casedeclined.risk') }}<!--<span style="color: red"> * </span>--></label>
                                ...
                                @if ($edit)
                                    @if (count($application->step) > 0 )
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="step_details_en">{{ __('admin.casedeclined.step_details_en') }}</label>
                                                    <textarea rows="1" class="form-control"
                                                        placeholder="{{ __('admin.casedeclined.step_details_en') }}"
                                                        name="arraydata[step{{$key+1}}][step_details_en]" required>{{$step->step_details_en}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="step_details_bn">{{ __('admin.casedeclined.step_details_bn') }}</label>
                                                    <textarea rows="1" class="form-control"
                                                        placeholder="{{ __('admin.casedeclined.step_details_bn') }}"
                                                        name="arraydata[step{{$key+1}}][step_details_bn]" required>{{$step->step_details_bn}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="users">{{ __('admin.casedeclined.users') }}</label>
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    ...
                                                    <a style="margin-top: 7px;" href="{{ route('admin.casedeclined.delete_step_info', $step->id) }}" href1="{{ route('admin.casedeclined.delete_step_info', [$step->id,1]) }}" class="btn btn-xs btn-danger deletes"><i class="fas fa-trash-alt"></i></a>
                                                </div>
                                            </div>
        ...
        $(document).ready(function () {
            ...
            $(add_button).click(function (e) {
                ...
                if (x < max_fields) {
                    ...
                    '<div class="col-md-4">'+
                        '<div class="form-group">'+
                            '<textarea rows="1" class="form-control" placeholder="{{ __('admin.casedeclined.step_details_en') }}" name="arraydata[step'+ x +'][step_details_en]" required></textarea>'+
                        '</div>'+
                    '</div>'+
                    '<div class="col-md-4">'+
                        '<div class="form-group">'+
                            '<textarea rows="1" class="form-control" placeholder="{{ __('admin.casedeclined.step_details_bn') }}" name="arraydata[step'+ x +'][step_details_bn]" required></textarea>'+
                        '</div>'+
                    '</div>'+
