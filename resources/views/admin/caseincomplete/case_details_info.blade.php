<div class="container-fluid pl-3 pt-2 " style="background-color: #F8FBF0" >
    ...
    <form>
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="row">
                    <div class="col-md-2">
                        <label for="name">{{ __('admin.caseincomplete.name') }}</label>
                    </div>
                    <div class="col-md-10">
            ...
            <li class="list-group-item">
                <div class="row">
                    <div class="col-md-2">
                        <label for="email">{{ __('admin.caseincomplete.age') }}</label>
                    </div>
                    <div class="col-md-10">
            ...
            <li class="list-group-item">
                <div class="row">
                    <div class="col-md-2">
                        <label for="message">{{ __('admin.caseincomplete.address') }}</label>
                    </div>
                    <div class="col-md-10">
            ...
            <li class="list-group-item">
                <div class="row">
                    <div class="col-md-2">
                        <label for="message">{{ __('admin.caseincomplete.case_category') }}</label>
                    </div>
                    <div class="col-md-10">
    ...
    <div class="row d-flex align-items-center py-4 pl-4">
        <div class="col-md-6">
            <h5 class="text-bold"> {{ __('admin.caseincomplete.victim') }}: ( {{ $application->{'name_' . app()->getLocale()} }} )
                {{ __('admin.caseincomplete.detail') }} </h5>
        </div>
        <div class="col-md-6 text-right">
            <a href="#" class="text-white rounded-pill p-4 mr-4" style="background-color: #6E4798">PDF ডাউনলোড করুন </a>
        </div>
            ...
            <div class="col-md-9">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="class">{{ __('admin.caseincomplete.class') }}</label>
                            </div>
                            <div class="col-md-9">
                                <span id="class">:
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="school">{{ __('admin.caseincomplete.school') }}</label>
                            </div>
                            <div class="col-md-9">
                                <span id="school">:
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="address">{{ __('admin.caseincomplete.address') }}</label>
                            </div>
                            <div class="col-md-9">
                                <span id="address">:
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="contact">{{ __('admin.caseincomplete.contact') }}</label>
                            </div>
                            <div class="col-md-9">
                                <span id="contact">:
                                     {{ (app()->getLocale() == 'en') ?
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="guardian">{{ __('admin.caseincomplete.guardian') }}</label>
                            </div>
                            <div class="col-md-9">
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="guardian_contact">{{ __('admin.caseincomplete.guardian_contact') }}</label>
                            </div>
                            <div class="col-md-9">
...
{{--    suspicious  info--}}
    ...
    <form>
        <div class="row bg-white py-2">
            ...
            <div class="col-md-3 text-bold">
                {{ __('admin.caseincomplete.suspicious_image') }} : <br>
                <img src="https://mdbcdn.b-cdn.net/img/new/avatars/9.webp" alt="Your Image" class="img-fluid rounded" />
            </div>
        </div>
    </form>
