    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) {
            ...
            if (x < max_fields) {
                ...
                '<div class="col-md-5">'+
                    '<div class="form-group">'+
                        '<textarea rows="2" class="form-control" placeholder="{{ __('admin.caseongoing.step_details_en') }}" name="arraydata[step'+ x +'][step_details_en]" required></textarea>'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-5">'+
                    '<div class="form-group">'+
                        '<textarea rows="2" class="form-control" placeholder="{{ __('admin.caseongoing.step_details_bn') }}" name="arraydata[step'+ x +'][step_details_bn]" required></textarea>'+
                    '</div>'+
                '</div>'+
