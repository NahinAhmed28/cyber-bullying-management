              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr style="background-color: #6E4798; border-radius: 25px;" class="text-light">
                    ...
                    <th>{{ __('admin.caseongoing.victim') }} {{ __('admin.admin.division') }}</th>
                    <th>{{ __('admin.caseongoing.victim') }} {{ __('admin.admin.district') }}</th>
                    <th>{{ __('admin.caseongoing.victim') }} {{ __('admin.admin.upazila') }}</th>
                    <th>{{ __('admin.caseongoing.victim') }} {{ __('admin.admin.thana') }}</th>

                    <th>{{__('admin.caseongoing.address')}}</th>

                    <th>{{__('admin.caseongoing.guardian')}}</th>
                    <th>{{__('admin.caseongoing.dob')}}</th>
                    <th>{{__('admin.caseongoing.age')}}</th>
                    <th>{{__('admin.caseongoing.gender')}}</th>
                    <th>{{__('admin.caseongoing.contact')}}</th>
                    <th>{{__('admin.caseongoing.guardian_contact')}}</th>

                    <th>{{__('admin.caseongoing.class')}}</th>
                    <th>{{__('admin.caseongoing.school')}}</th>


                    <th>{{__('admin.caseongoing.title')}}</th>
                    <th>{{__('admin.caseongoing.title_details')}}</th>
                    <th>{{__('admin.caseongoing.created_at')}}</th>

                    <th>{{__('admin.caseongoing.update_suspicious_info')}}</th>
                    <th>{{__('admin.caseongoing.update_step_info')}}</th>
                    <th>{{__('admin.caseongoing.update_addmember_info')}}</th>

                    <th>{{__('admin.caseongoing.action')}}</th>
                  </tr>
                  </thead>
                  <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      @can('edit_suspicious_info', app('App\Models\Caseongoing'))
                        <a href="{{ route('admin.caseongoing.edit_suspicious_info', $application->id) }}" class="btn btn-xs btn-primary">
                          {{__('admin.caseongoing.update_suspicious_info_ans')}}
                        </a>
                      @endcan
                    </td>
                    ...
                    <td>
                      @can('update', app('App\Models\Caseongoing'))
                        <a href="{{ route('admin.caseongoing.edit', $application->id) }}" class="btn btn-xs btn-primary"><i class="fas fa-edit"></i></a>
                      @endcan

                      @can('delete', app('App\Models\Caseongoing'))
                        <a href="{{ route('admin.caseongoing.delete', $application->id) }}" href1="{{ route('admin.caseongoing.delete', [$application->id,1]) }}" class="btn btn-xs btn-danger delete"><i class="fas fa-trash-alt"></i></a>
                      @endcan
