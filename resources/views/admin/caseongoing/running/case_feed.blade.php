<div class="row" style="background-color: #F8FBF0">
    <div class="col-md-8 card">
        <div class="card p-4 m-4" style="background-color: #FF60561A">
            ...
            <div class="row">
                <div class="col-md-2">
                    @if (@$application->approveBy && @$application->approveBy->thumb)

                        <img class="rounded-circle" style="max-width: 150px; max-height: 80px" alt="avatar1"
                             src="{{ asset('storage/'.@$application->approveBy->thumb) }}" />
                ...
                <div class="col-md-10 pt-2">
                    @if (@$application->approveBy)
                    <span class="text-bold">{{@$application->approveBy->{'title_'. app()->getLocale()} }}</span>
                    {{-- <p> {{ (app()->getLocale() == 'en') ? " {@$application->approveBy->designation->title_en} Juvenile Cyber Crime Prevention Central Committee." : " {@$application->approveBy->designation->title_bn}  কিশোর কিশোরীদের সাইবার অপরাধ প্রতিরোধ কেন্দ্রীয় কমিটি।" }} <br>
                        {{ (app()->getLocale() == 'en') ? "Director ( {@$application->approveBy->officeDesignation->title_en} ), Digital Security Agency." : "পরিচালক ( {@$application->approveBy->officeDesignation->title_bn} ), ডিজিটাল নিরাপত্তা এজেন্সি।" }}
                    </p> --}}

                    <p> {{@$application->approveBy->designation->{'title_'. app()->getLocale()} }},  {{(app()->getLocale() == 'en') ? "Juvenile Cyber Crime Prevention Committee." : "কিশোর কিশোরীদের সাইবার অপরাধ প্রতিরোধ কমিটি।"}} <br>
                        {{@$application->approveBy->officeDesignation->{'title_'. app()->getLocale()} }},  {{(app()->getLocale() == 'en') ? "Digital Security Agency." : "ডিজিটাল নিরাপত্তা এজেন্সি।"}}
                    </p>
                    @else
            ...
            <div class="row">
                ...
                <div class="col-md-10 pt-2">
                    ...
                    <p> {{@$item->admin->designation->{'title_'. app()->getLocale()} }},  {{(app()->getLocale() == 'en') ? "Juvenile Cyber Crime Prevention Central Committee." : "কিশোর কিশোরীদের সাইবার অপরাধ প্রতিরোধ কমিটি।"}} <br>
                        {{@$item->admin->officeDesignation->{'title_'. app()->getLocale()} }},  {{(app()->getLocale() == 'en') ? "Digital Security Agency." : "ডিজিটাল নিরাপত্তা এজেন্সি।"}}
                    </p>
