...
<div class="content-wrapper">
    ...
    <form class="form-edit-add" application="form" id="application_entry_form"
        action="{{ route('admin.caseongoing.update_step_info', $application->id) }} }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        @if($edit)
                                            <div class="form-group">
                                                <label for="case_status_id">{{ __('admin.caseongoing.case_status') }}<!--<span style="color: red"> * </span>--></label>
                                    ...
                                    <div class="col-md-4">
                                        @if($edit)
                                            <div class="form-group">
                                                <label for="risk_id">{{ __('admin.caseongoing.risk') }}<!--<span style="color: red"> * </span>--></label>
