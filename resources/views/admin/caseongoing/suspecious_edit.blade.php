    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('admin.caseongoing') }}"
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) {
            ...
            if (x < max_fields) {
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][suspicious_name_en]" placeholder="{{ __('admin.caseongoing.suspicious_name_en') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][suspicious_name_bn]" placeholder="{{ __('admin.caseongoing.suspicious_name_bn') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][suspicious_guardian_en]" placeholder="{{ __('admin.caseongoing.suspicious_guardian_en') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="text" name="arraydata[suspect'+ x +'][suspicious_guardian_bn]" placeholder="{{ __('admin.caseongoing.suspicious_guardian_bn') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group">'+
                        '<input type="number" name="arraydata[suspect'+ x +'][suspicious_guardian_contact]" placeholder="{{ __('admin.caseongoing.suspicious_guardian_contact') }}" value="" class="form-control">'+
                    '</div>'+
                '</div>'+
                ...
                '<div class="col-md-3">'+
                    '<div class="form-group" style="margin-top: 8px;">'+
                        ...
                        '<div class="form-check-inline">'+
                            '<label class="form-check-label">'+
                                '<input type="radio" class="form-check-input" name="arraydata[suspect'+ x +'][suspicious_gender]" value="1">{{ __('admin.caseongoing.suspicious_male') }}'+
                            '</label>'+
                        '</div>'+
                        '<div class="form-check-inline">'+
                            '<label class="form-check-label">'+
                                '<input type="radio" class="form-check-input" name="arraydata[suspect'+ x +'][suspicious_gender]" value="0">{{ __('admin.caseongoing.suspicious_female') }}'+
                            '</label>'+
                        '</div>'+
                    '</div>'+
                '</div>'+
