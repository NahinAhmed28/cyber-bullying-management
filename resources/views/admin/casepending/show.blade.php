                        ...
                        <div class="card">
                            <div class="tab-content">
                                <div id="home" class="tab-pane fade show active">
                                    @include('admin.casepending.case_feed')
                                </div>
                                <div id="menu1" class="tab-pane fade">
                                    @include('admin.casepending.case_asset')
                                </div>
                                <div id="menu2" class="tab-pane fade">
                                    @include('admin.casepending.case_member')
                                </div>
                                <div id="menu3" class="tab-pane fade">
                                    @include('admin.casepending.case_details_info')
                                </div>
                            </div>
                        </div>
                    </div>
