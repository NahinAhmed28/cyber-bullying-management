...
<div class="content-wrapper">
    ...
    <form class="form-edit-add" application="form" id="application_entry_form"
        action="{{ !$edit ? route('admin.casepending.store') : route('admin.casepending.update', $application->id) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title text-info">{{ __('admin.casepending.victim_info') }}</h3>
                            </div>

                            <div class="card-body">

                                <div class="form-group">
                                    <label for="name_en">{{ __('admin.casepending.name_en') }}</label>
                                    <input type="text" name="name_en" id="name_en"
                                        placeholder="{{ __('admin.casepending.name_en') }}"
                                        value="{{ $edit?$application->name_en:old('name_en') }}"
                                        class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="name_bn">{{ __('admin.casepending.name_bn') }}</label>
                                    <input type="text" name="name_bn" id="name_bn"
                                        placeholder="{{ __('admin.casepending.name_bn') }}"
                                ...
                                <div class="form-group">
                                    <label for="dob">{{ __('admin.casepending.dob') }} </label>
                                    <input type="text" name="dob" id="dob"
                                        placeholder="{{ __('admin.casepending.dob') }}"
                                ...
                                @if ($edit)
                                    <div class="form-group">
                                    <label for="division_id">{{ __('admin.casepending.victim') }} {{ __('admin.admin.division') }} <!--<span style="color: red"> * </span>--></label>
                                ...
                                @if ($edit)
                                    <div class="form-group">
                                    <label for="district_id">{{ __('admin.casepending.victim') }} {{ __('admin.admin.district') }} <!--<span style="color: red"> * </span>--></label>
                                ...
                                @if ($edit)
                                    <div class="form-group">
                                    <label for="upazila_id">{{ __('admin.casepending.victim') }} {{ __('admin.admin.upazila') }} <!--<span style="color: red"> * </span>--></label>
                                ...
                                @if ($edit)
                                    <div class="form-group">
                                    <label for="thana_id">{{ __('admin.casepending.victim') }} {{ __('admin.admin.thana') }}</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                {{-- <div class="form-group">
                                    <label for="email">{{ __('admin.casepending.email') }}</label>
                                    <input type="email" name="email" id="email"
                                        placeholder="{{ __('admin.casepending.email') }}"
                                        value="{{ $edit?$application->email:old('email') }}"
                                        class="form-control">
                                </div> --}}

                                {{-- <div class="form-group">
                                    <label for="nid">{{ __('admin.casepending.nid') }}</label>
                                    <input type="text" name="nid" id="nid"
                                        placeholder="{{ __('admin.casepending.nid') }}"
                                        value="{{ $edit?$application->nid:old('nid') }}"
                                        class="form-control" minlength="10" maxlength="17" onkeypress='validate(event)'>
                                </div>

                                <div class="form-group">
                                  <label for="passport">{{ __('admin.casepending.passport') }}</label>
                                  <input type="text" name="passport" id="passport"
                                      placeholder="{{ __('admin.casepending.passport') }}"
                                ...
                                <div class="form-group">
                                    <label for="title_bn"
                                        style="padding-right:20%;padding-top: 3%;">{{ __('admin.casepending.gender') }}
                                        : </label> <br>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="gender" value="1"
                                                {{ ($edit && ($application->gender)) ? 'checked' : '' }}>{{ __('admin.casepending.male') }}
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="gender" value="0"
                                                {{ ($edit && (!$application->gender)) ? 'checked' : '' }}>{{ __('admin.casepending.female') }}
                                        </label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="class_en">{{ __('admin.casepending.class_en') }}</label>
                                    <input type="text" name="class_en" id="class_en"
                                        placeholder="{{ __('admin.casepending.class_en') }}"
                                        value="{{ $edit?$application->class_en:old('class_en') }}"
                                        class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="class_bn">{{ __('admin.casepending.class_bn') }}</label>
                                    <input type="text" name="class_bn" id="class_bn"
                                        placeholder="{{ __('admin.casepending.class_bn') }}"
                                        value="{{ $edit?$application->class_bn:old('class_bn') }}"
                                        class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="school_en">{{ __('admin.casepending.school_en') }}</label>
                                    <input type="text" name="school_en" id="school_en"
                                        placeholder="{{ __('admin.casepending.school_en') }}"
                                        value="{{ $edit?$application->school_en:old('school_en') }}"
                                        class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="school_bn">{{ __('admin.casepending.school_bn') }}</label>
                                    <input type="text" name="school_bn" id="school_bn"
                                        placeholder="{{ __('admin.casepending.school_bn') }}"
                                ...
                                <div class="form-group">
                                    <label
                                        for="address_en">{{ __('admin.casepending.address_en') }}</label>
                                    <textarea rows="1" id="address_en" class="form-control"
                                        placeholder="{{ __('admin.casepending.address_en') }}"
                                        name="address_en"
                                ...
                                <div class="form-group">
                                    <label
                                        for="address_bn">{{ __('admin.casepending.address_bn') }}</label>
                                    <textarea rows="1" id="address_bn" class="form-control"
                                        placeholder="{{ __('admin.casepending.address_bn') }}"
                                        name="address_bn"
                                ...
                                {{-- <div class="form-group">
                                    <label for="title_bn"
                                        style="padding-right:8%;padding-top: 3%;">{{ __('admin.casepending.marital') }}: </label>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="marital" value="1"
                                                {{ ($edit && ($application->marital)) ? 'checked' : '' }}>{{ __('admin.casepending.married') }}
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="marital" value="0"
                                                {{ ($edit && (!$application->marital)) ? 'checked' : '' }}>{{ __('admin.casepending.unmarried') }}
                                        </label>
                                    </div>
                                </div> --}}
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label
                                        for="guardian_en">{{ __('admin.casepending.guardian_en') }}</label>
                                    <input type="text" name="guardian_en" id="guardian_en"
                                        placeholder="{{ __('admin.casepending.guardian_en') }}"
                                ...
                                <div class="form-group">
                                    <label
                                        for="guardian_bn">{{ __('admin.casepending.guardian_bn') }}</label>
                                    <input type="text" name="guardian_bn" id="guardian_bn"
                                        placeholder="{{ __('admin.casepending.guardian_bn') }}"
                                ...
                                <div class="form-group">
                                    <label
                                        for="guardian_contact">{{ __('admin.casepending.guardian_contact') }}</label>
                                    <input type="text" name="guardian_contact" id="guardian_contact"
                                        placeholder="{{ __('admin.casepending.guardian_contact') }}"
                                ...
                                <div class="form-group">
                                    <label
                                        for="contact">{{ __('admin.casepending.contact') }}</label>
                                    <input type="text" name="contact" id="contact"
                                        placeholder="{{ __('admin.casepending.contact') }}"
                                ...
                                {{-- <div class="form-group">
                                    <label
                                        for="spouse_en">{{ __('admin.casepending.spouse_en') }}</label>
                                    <input type="text" name="spouse_en" id="spouse_en"
                                        placeholder="{{ __('admin.casepending.spouse_en') }}"
                                ...
                                <div class="form-group">
                                    <label
                                        for="spouse_bn">{{ __('admin.casepending.spouse_bn') }}</label>
                                    <input type="text" name="spouse_bn" id="spouse_bn"
                                        placeholder="{{ __('admin.casepending.spouse_bn') }}"
                                ...
                                <div class="form-group">
                                    <label for="dsign">
                                        {{ __('admin.casepending.dsign') }} <span
                                            class="text-warning">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title text-info">{{ __('admin.casepending.application_info') }}</h3>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label
                                        for="title_en">{{ __('admin.casepending.title_en') }}</label>
                                    <textarea rows="1" id="title_en" class="form-control"
                                        placeholder="{{ __('admin.casepending.title_en') }}"
                                        name="title_en"
                                ...
                                <div class="form-group">
                                    <label
                                        for="title_bn">{{ __('admin.casepending.title_bn') }}</label>
                                    <textarea rows="1" id="title_bn" class="form-control"
                                        placeholder="{{ __('admin.casepending.title_bn') }}"
                                        name="title_bn"
                                ...
                                <div class="form-group">
                                    <label
                                        for="title_details_en">{{ __('admin.casepending.title_details_en') }}</label>
                                    <textarea rows="1" id="title_details_en" class="form-control"
                                        placeholder="{{ __('admin.casepending.title_details_en') }}"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label
                                        for="title_details_bn">{{ __('admin.casepending.title_details_bn') }}</label>
                                    <textarea rows="1" id="title_details_bn" class="form-control"
                                        placeholder="{{ __('admin.casepending.title_details_bn') }}"
                                ...
                                @if($edit)
                                    <div class="form-group">
                                        <label for="case_type_id">{{ __('admin.casepending.case_type') }}<!--<span style="color: red"> * </span>--></label>
                                ...
                                @if($edit)
                                    <div class="form-group">
                                        <label for="case_category_id">{{ __('admin.casepending.case_category') }}<!--<span style="color: red"> * </span>--></label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title text-info">{{ __('admin.casepending.documents_info') }}</h3>
                            </div>
                            ...
                            <div class="card-body">
                                @if ($edit)
                                    @if (count($application->file) > 0 )
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="text" name="arraydata[file{{$key+1}}][title_en]" id="title_en{{$key+1}}" placeholder="{{ __('admin.casepending.file_title_en') }}" value="{{@$file->title_en}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="text" name="arraydata[file{{$key+1}}][title_bn]" id="title_bn{{$key+1}}" placeholder="{{ __('admin.casepending.file_title_bn') }}" value="{{@$file->title_bn}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                @can('delete_single_file', app('App\Models\Casepending'))
                                                <div class="form-group">
                                    ...
                                    @else
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="text" name="arraydata[file1][title_en]" id="title_en" placeholder="{{ __('admin.casepending.file_title_en') }}" value="{{@$file->title_en}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="text" name="arraydata[file1][title_bn]" id="title_bn" placeholder="{{ __('admin.casepending.file_title_bn') }}" value="{{@$file->title_bn}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                ...
                                @endif
                                @can('update_evidence_files', app('App\Models\Casepending'))
        ...
        $(add_button).click(function (e) {
            ...
            if (x < max_fields) {
                ...
                $(wrapper).append('<div class="row">' +
                    '<div class="col-md-3">' +
                      '<div class="form-group">' +
                        '<input type="text" name="arraydata[file'+ x +'][title_en]" id="title_en'+ x +'" placeholder="{{ __('admin.casepending.file_title_en') }}" value="" class="form-control">' +
                      '</div>' +
                    '</div>' +
                    '<div class="col-md-3">' +
                      '<div class="form-group">' +
                        '<input type="text" name="arraydata[file'+ x +'][title_bn]" id="title_bn'+ x +'" placeholder="{{ __('admin.casepending.file_title_bn') }}" value="" class="form-control">' +
                      '</div>' +
                    '</div>' +
                    '<div class="col-md-3">' +
                      '<div class="form-group">' +
