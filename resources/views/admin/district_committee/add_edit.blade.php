...
@section('breadcrumb')
  @include('../admin.layouts.partials.breadcrumb', ['path1' => __('admin.menu.district_committee'), 'route1' => route('admin.district_committee') ])
@endsection
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            <a href="{{ route('admin.district_committee') }}" class="btn btn-outline-light form-control btn-add-new">
          ...
          <div class="col-sm-10">
            <h1 class="text-info">
              @if ($edit)
                <i class="fas fa-bookmark"></i> {{ __('admin.common.update') }} {{ __('admin.menu.district_committee') }} {{ __('admin.common.info') }}
              @else
                <i class="fas fa-bookmark"></i> {{ __('admin.common.add') }} {{ __('admin.menu.district_committee') }} {{ __('admin.common.info') }}
              @endif
...
<form class="form-edit-add" role="form" id="admin_entry_form"
              action="{{!$edit ? route('admin.district_committee.store') : route('admin.district_committee.update', $admin->id)}}"
                ...
                <div class="card-body">
                  ...
                  @if ($edit)
                    <div class="form-group">
                      <label for="user_type_id">{{ __('admin.district_committee.user_type') }}</label>
                  ...
                  @if ($edit)
                    <div class="form-group">
                      <label for="role_id">{{ __('admin.district_committee.role') }} <!--<span style="color: red"> * </span>--></label>
                  ...
                  @if ($edit)
                    <div class="form-group">
                      <label for="division_id">{{ __('admin.district_committee.division') }} <!--<span style="color: red"> * </span>--></label>
                  ...
                  @if ($edit)
                    <div class="form-group">
                      <label for="district_id">{{ __('admin.district_committee.district') }} <!--<span style="color: red"> * </span>--></label>
                  ...
                  {{-- @if ($edit)
                    <div class="form-group">
                      <label for="upazila_id">{{ __('admin.district_committee.upazila') }} <!--<span style="color: red"> * </span>--></label>
                  ...
                  {{-- @if ($edit)
                    <div class="form-group">
                      <label for="thana_id">{{ __('admin.district_committee.thana') }}</label>
                  ...
                  {{-- @if ($edit)
                    <div class="form-group">
                      <label for="area_id">{{ __('admin.district_committee.area') }}</label>
                  ...
                  @if ($edit)
                    <div class="form-group">
                      <label for="branch_id">{{ __('admin.district_committee.branch') }}</label>
            ...
            <div class="col-4">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="title_en">{{ __('admin.district_committee.title_en') }}</label>
                    <input type="text" name="title_en"
                     id="title_en" placeholder="{{ __('admin.district_committee.title_en') }}"
                     value="{{ $edit?$admin->title_en:old('title_en') }}"
                     class="form-control" required>
                  </div>

                  <div class="form-group">
                    <label for="title_bn">{{ __('admin.district_committee.title_bn') }}</label>
                    <input type="text" name="title_bn"
                     id="title_bn" placeholder="{{ __('admin.district_committee.title_bn') }}"
                     value="{{ $edit?$admin->title_bn:old('title_bn') }}"
                     class="form-control">
                  </div>

                  <div class="form-group">
                    <label for="username">{{ __('admin.district_committee.username') }}</label>
                    <input type="text" name="username"
                     id="username" placeholder="{{ __('admin.district_committee.username') }}"
                  ...
                  @if ($edit)
                    <div class="form-group">
                      <label for="designation_id">{{ __('admin.district_committee.designation') }}</label>
                  ...
                  @if ($edit)
                    <div class="form-group">
                      <label for="office_designation_id">{{ __('admin.district_committee.office_designation') }}</label>
                  ...
                  {{-- @if (true)
                  <div class="form-group">
                    <label for="office_en">{{ __('admin.district_committee.office_en') }}</label>
                    <textarea rows="1" id="office_en" class="form-control" placeholder="{{ __('admin.district_committee.office_en') }}"
                    name="office_en">{{ $edit?$admin->office_en:old('office_en') }}</textarea>
                  </div>

                  <div class="form-group">
                    <label for="office_bn">{{ __('admin.district_committee.office_bn') }}</label>
                    <textarea rows="1" id="office_bn" class="form-control" placeholder="{{ __('admin.district_committee.office_bn') }}"
                  ...
                  <div class="form-group">
                    <label for="address_en">{{ __('admin.district_committee.address_en') }}</label>
                    <textarea rows="1" id="address_en" class="form-control" placeholder="{{ __('admin.district_committee.address_en') }}"
                    name="address_en" required>{{ $edit?$admin->address_en:old('address_en') }}</textarea>
                  </div>

                  <div class="form-group">
                    <label for="address_bn">{{ __('admin.district_committee.address_bn') }}</label>
                    <textarea rows="1" id="address_bn" class="form-control" placeholder="{{ __('admin.district_committee.address_bn') }}"
            ...
            <div class="col-4">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="email">{{ __('admin.district_committee.email') }}</label>
                    <input type="email" name="email"
                     id="email" placeholder="{{ __('admin.district_committee.email') }}"
                  ...
                  @if ($edit)
                  <div class="form-group">
                    <label for="status">{{ __('admin.district_committee.status') }}  </label><br>
                  ...
                  <div class="form-group">
                    <label for="contact">{{ __('admin.district_committee.contact') }}</label> <span class="text-info">({{__('admin.common.en_lang_use')}}) </span>
                    <input type="text" name="contact"
                     id="contact" placeholder="{{ __('admin.district_committee.contact') }}"
                     value="{{ $edit?$admin->contact:old('contact') }}"
                     class="form-control" >
                  </div>

                  <div class="form-group">
                    <label for="password">{{ __('admin.district_committee.password') }}</label>
                    <input type="password" name="password"
                     id="password" placeholder="{{ __('admin.district_committee.password') }}"
                     value="{{ $edit?'':old('password') }}" {{$edit?'disabled':'required'}}
                     class="form-control" >
                  </div>

                  <div class="form-group">
                    <label for="password_confirmation">{{ __('admin.district_committee.password_confirmation') }}</label>
                    <input type="password" name="password_confirmation"
                     id="password_confirmation" placeholder="{{ __('admin.district_committee.password_confirmation') }}"
                  ...
                  <div class="form-group">
                    <label for="thumb">
                        {{ __('admin.district_committee.thumb') }} <span
                  ...
                  <div class="form-group">
                    <label for="dsign">
                        {{ __('admin.district_committee.dsign') }} <span
                                class="text-warning">({{__('admin.common.max_size')}})</span>
                    </label>
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-info btn-sm form-control search1 save1">
