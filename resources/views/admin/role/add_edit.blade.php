    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            <a href="{{ route('admin.role') }}" class="btn btn-outline-light form-control btn-add-new">
          ...
          <div class="col-sm-10">
            <h1 class="text-light">
              @if ($edit)
                <i class="fas fa-bookmark"></i> {{ __('admin.common.update') }} {{ __('admin.menu.role') }} {{ __('admin.common.info') }}
              @else
                <i class="fas fa-bookmark"></i> {{ __('admin.common.add') }} {{ __('admin.menu.role') }} {{ __('admin.common.info') }}
              @endif
...
<form class="form-edit-add" role="form" id="role_entry_form"
              action="{{!$edit ? route('admin.role.store') : route('admin.role.update', $role->id)}}"
            ...
            <div class="col-6">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="title_en">{{ __('admin.role.title_en') }}</label>
                    <input type="text" name="title_en"
                     id="title_en" placeholder="{{ __('admin.role.title_en') }}"
                     value="{{ $edit?$role->title_en:old('title_en') }}"
                     class="form-control" >
                  </div>

                  <div class="form-group">
                    <label for="title_bn">{{ __('admin.role.title_bn') }}</label>
                    <input type="text" name="title_bn"
                     id="title_bn" placeholder="{{ __('admin.role.title_bn') }}"
