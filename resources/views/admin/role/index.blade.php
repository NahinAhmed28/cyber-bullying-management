      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            ...
            <a href="{{ route('admin.role.create') }}" class="btn btn-outline-light form-control btn-add-new">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    {{-- <th>{{__('admin.role.code')}}</th> --}}
                    <th>{{__('admin.role.created_at')}}</th>
                  ...
                  <tr>
                    ...
                    <td>{{$role->{'title_'. app()->getLocale()} }}</td>
                    {{-- <td>{{(app()->getLocale() == 'en') ? $role->code : engToBnHlp($role->code)}}</td> --}}
                    <td>{{(app()->getLocale() == 'en') ? date('d-m-Y', strtotime($role->created_at)) : dateFormatEnglishToBanglaHlp(date('d-m-Y', strtotime($role->created_at)))}}</td>
                    <td>
                      ...
                      @can('delete', app('App\Models\Role'))
                        <a href="{{ route('admin.role.delete', $role->id) }}" href1="{{ route('admin.role.delete', [$role->id,1]) }}" class="btn btn-xs btn-danger delete"><i class="fas fa-trash-alt"></i></a>
                      @endcan
