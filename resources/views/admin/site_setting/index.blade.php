        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            @can('create', app('App\Models\SiteSetting'))
              <a href="{{ route('admin.site_setting.create') }}" class="btn btn-outline-light form-control btn-add-new">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>{{$key+1}}</td>
                    <td>{{ $site_setting->{'title_'. app()->getLocale()} }}</td>
                    <td>{{ $site_setting->{'site_address_'. app()->getLocale()} }}</td>
                    <td>{!! $site_setting->{'footer_'. app()->getLocale()} !!}</td>
                    {{-- <td>{{(app()->getLocale() == 'en') ? $site_setting->site_mobile : engToBnHlp($site_setting->site_mobile)}}</td> --}}
                    <td>{{(app()->getLocale() == 'en') ? $site_setting->site_mobile : engToBnHlp($site_setting->site_mobile)}}</td>
                    <td>{{$site_setting->site_email}}</td>
                    <td>{{$site_setting->site_web}}</td>
                    <td>{{(app()->getLocale() == 'en') ? $site_setting->vat : engToBnHlp($site_setting->vat)}}</td>
