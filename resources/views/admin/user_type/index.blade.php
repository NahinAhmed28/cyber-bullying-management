    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            <a href="{{ route('admin.user_type.create') }}" class="btn btn-outline-light form-control btn-add-new">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>{{(app()->getLocale() == 'en') ? $user_type->sort : engToBnHlp($user_type->sort)}}</td>
                    <td>{{$user_type->{'title_'. app()->getLocale()} }}</td>
                    {{-- <td>{{(app()->getLocale() == 'en') ? $user_type->code : engToBnHlp($user_type->code)}}</td> --}}
                    ...
                    <td>{{(app()->getLocale() == 'en') ? date('d-m-Y', strtotime($user_type->created_at)) : dateFormatEnglishToBanglaHlp(date('d-m-Y', strtotime($user_type->created_at)))}}</td>
